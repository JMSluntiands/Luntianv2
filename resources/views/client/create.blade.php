...
@section('content')
    <div class="client-form-page">
        <div class="client-form-header">
            <h1 class="client-form-title">Add Client</h1>
            <p class="client-form-subtitle">Create a new client account.</p>
        </div>
        ...
        <form action="{{ route('client.store') }}" method="POST" class="client-form" autocomplete="off">
            @csrf
            <div class="client-card">
                <div class="client-form-group">
                    <label class="client-label" for="client_account_name">Name</label>
                    <input type="text" id="client_account_name" name="client_account_name" class="client-input" placeholder="e.g. Company Name, Client Name" value="{{ old('client_account_name') }}" autocomplete="off">
                </div>
            </div>
...
@push('styles')
    <style>
        ...
        body.page-client-create .content { padding-bottom: 0; }
