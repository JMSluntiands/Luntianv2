                            ...
                            <tr class="lbs-data-row border-b border-slate-200 align-middle text-slate-800 transition-colors hover:bg-slate-50 dark:border-slate-700 dark:text-slate-200 dark:hover:bg-white/5" data-job-id="{{ $job->job_id }}" data-job-units="{{ (int) ($job->units ?? 0) }}" data-update-url="{{ route('general_assembly.job.update', ['id' => $job->job_id]) }}" data-log-date-key="{{ $logDateFilter }}" data-builder="{{ $builderFilter }}" data-priority="{{ $priorityFilter }}">
                                ...
                                <td class="lbs-td border-b border-slate-200 px-4 py-3 align-middle text-slate-800 dark:border-slate-700 dark:text-slate-200" data-label="Complexity" data-sort="{{ $complexity }}" style="white-space: nowrap;">
                                    <span class="lbs-stars inline-flex items-center" data-rating="{{ $complexity }}" aria-label="{{ $complexity }} out of 5">
                                        @include('general-assembly.partials.stars', ['rating' => $complexity])
                                    </span>
                                </td>
                            </tr>
                                    ...
                                    <div class="px-0 py-0">
                                        <div class="grid gap-x-6 gap-y-4 px-5 py-5" style="grid-template-columns: repeat(auto-fill, minmax(200px, 1fr));">
                                            ...
                                            <div class="flex flex-col gap-1.5">
                                                ...
                                                <span class="text-[0.9375rem] font-medium leading-snug text-slate-800 dark:text-slate-200">@include('general-assembly.partials.stars', ['rating' => $complexity])</span>
                                            </div>
                                        </div>
                                    </div>
                                </td>
