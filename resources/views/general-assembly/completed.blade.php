...
@section('title', (isset($isLuntian) && $isLuntian) ? 'Luntian Completed' : ((isset($isEfficientLiving) && $isEfficientLiving) ? 'Efficient Living Completed' : 'Generic EA Completed'))
