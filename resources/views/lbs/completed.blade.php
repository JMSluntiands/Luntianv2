...
@push('styles')
    <style>
        ...
        body.page-lbs-completed .content { padding-bottom: 0; }
        ...
        .lbs-th { text-align: left; padding: 0.75rem 1.25rem; white-space: nowrap; font-weight: 600; color: #94a3b8; background: #1e293b; border-bottom: 1px solid #334155; white-space: nowrap; cursor: pointer; user-select: none; vertical-align: middle; word-spacing: normal; }
        .lbs-th:hover { color: #e2e8f0; }
        .lbs-th .lbs-sort-icon { margin-left: 0.25rem; opacity: 0.6; font-size: 0.75rem; }
        .lbs-th[data-sort="asc"] .lbs-sort-icon,
        ...
        .lbs-stars-inner { display: inline-flex; align-items: center; gap: 0.1rem; }
        .lbs-star { flex-shrink: 0; }
        ...
        html[data-theme="light"] .lbs-action-duplicate:hover { color: #2C528B; background: rgba(44,82,139,0.12); }
        html[data-theme="light"] .lbs-action-view:hover { color: #15803d; background: rgba(34,197,94,0.12); }
        ...
        html[data-theme="light"] .lbs-action-collapse:hover { color: #dc2626; background: rgba(220,38,38,0.1); }
        html[data-theme="light"] .lbs-detail-label { color: #64748b; }
        html[data-theme="light"] .lbs-detail-value { color: #1e293b; }
        @media (max-width: 768px) {
            .lbs-list-header { margin-bottom: 1.25rem; flex-direction: column; align-items: stretch; }
            .lbs-list-search-wrap { width: 100%; }
            .lbs-search-input-wrap { min-width: 0; width: 100%; }
            .lbs-list-title { font-size: 1.25rem; }
            .lbs-list-subtitle { font-size: 0.875rem; }
            .lbs-table-wrap { overflow-x: auto; -webkit-overflow-scrolling: touch; }
            .lbs-table { min-width: 1320px; }
            .lbs-th { padding: 0.6rem 0.75rem; font-size: 0.8125rem; }
            .lbs-td { padding: 0.6rem 0.75rem; font-size: 0.8125rem; }
            .lbs-detail-panel { padding: 0.75rem 1rem; }
            .lbs-detail-grid { grid-template-columns: 1fr; gap: 0.5rem 0; padding: 1rem; }
            .lbs-detail-label { font-size: 0.6875rem; }
            .lbs-detail-value { font-size: 0.875rem; }
        }
        @media (max-width: 480px) {
            .lbs-th { padding: 0.5rem 0.6rem; font-size: 0.75rem; }
            .lbs-td { padding: 0.5rem 0.6rem; font-size: 0.75rem; }
            .lbs-detail-grid { padding: 0.75rem; }
        }
    </style>
@endpush
