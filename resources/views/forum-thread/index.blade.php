...
@endphp
    ...
    <div class="w-full max-w-full px-0">
        ...
        @if($canPost)
            ...
            <div class="mb-6 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-700 dark:bg-slate-800/70 sm:p-6">
        ...
        <div class="space-y-4">
            @forelse($posts as $post)
                ...
                @endphp
                <article id="post-{{ $post->id }}" class="rounded-2xl border border-slate-200 bg-white shadow-sm dark:border-slate-700 dark:bg-slate-800/70">
