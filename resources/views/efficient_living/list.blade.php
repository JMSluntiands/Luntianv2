                ...
                <table class="efficient_living-table" id="efficient_livingTable">
                    ...
                    <tbody>
                        @forelse($jobs ?? [] as $job)
                            ...
                            @endphp
                            <tr class="efficient_living-data-row lbs-data-row" data-job-id="{{ $job->job_id }}" data-job-units="{{ (int) ($job->units ?? 0) }}" data-update-url="{{ route('efficient_living.job.update', ['id' => $job->job_id], false) }}">
